...
const config = {
  ...
  publicRuntimeConfig: {
    ...
    hostName: process.env.NEXT_PUBLIC_VERCEL_URL || 'javadrip.coffee',
  ...
  serverRuntimeConfig: {
    ...
    previewSecret: process.env.NEXT_PUBLIC_UNIFORM_PREVIEW_SECRET || 'javadrip',
    ...
    algoliaAdminKey: process.env.NEXT_PUBLIC_ALGOLIA_ADMIN_KEY,
